...
import delimited using "output\js_all_data_regress_iq8_results.csv", clear
describe
...
graph export "output\js_all_data_regress_iq8_exposures_plot_by_depvars.png", width(2000) height(1200) replace
